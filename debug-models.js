...
const checkModels = async () => {
  try {
    ...
    if (FileDB.FileDBSubscription) {
      console.log('FileDBSubscription methods:', Object.getOwnPropertyNames(FileDB.FileDBSubscription));
      console.log('FileDBSubscription create method type:', typeof FileDB.FileDBSubscription.create);
    }
