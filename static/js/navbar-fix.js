...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function applyNavbarFix() {
    ...
    navbarElements.forEach(element => {
      element.setAttribute('style', 'background-color: #343a40 !important; color: white !important;');
    });
    ...
    const navLinks = document.querySelectorAll('.navbar > .nav-link, .navbar-brand, .navbar > i, .navbar > a, .navbar .nav-item > a, .nav-link.dropdown-toggle');
    ...
    togglerIcons.forEach(icon => {
      icon.setAttribute('style', 'background-image: url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 30 30\'%3e%3cpath stroke=\'rgba%28255, 255, 255, 0.9%29\' stroke-linecap=\'round\' stroke-miterlimit=\'10\' stroke-width=\'2\' d=\'M4 7h22M4 15h22M4 23h22\'/%3e%3c/svg%3e") !important;');
    });
  }
