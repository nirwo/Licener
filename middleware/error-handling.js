...
const errorHandlerMiddleware = (err, req, res, next) => {
  ...
  if (err.message && err.message.includes("Cannot read properties of undefined (reading 'toString')")) {
    ...
    if (req.path !== '/auth/login' && req.path !== '/auth/register' && !req.path.startsWith('/static/')) {
